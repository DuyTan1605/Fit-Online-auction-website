...
(function (factory) {
    ...
    FileInput.prototype = {
        ...
        _validateAllImages: function () {
            var self = this, i, counter = {val: 0}, numimages = self.loadedImages.length, config,
                fsize, minSize = self.resizeIfSizeMoreThan;
            if (numimages !== self.totalImagesCount) {
                return;
            }
            ...
            for (i = 0; i < self.loadedImages.length; i++) {
                ...
                if (fsize && fsize > minSize * 1000) {
                    self._getResizedImage(config, counter, numimages);
                }
                self.loadedImages[i].validated = true;
            }
        },
        _getResizedImage: function (config, counter, numimages) {
